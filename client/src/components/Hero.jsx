  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>
      <div className='text-center mb-6'>
        <h1 className='text-3xl sm:text-5xl md:text-6xl 2xl:text-7xl font-semibold mx-auto leading-[1.2]'>Create amzing content 
        ...
        <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl m-auto max-sm:text-xs text-gray-600'>Transform your content creation with our suite of premium AI tools.
            Write articles,genrate images, remove backgrounds, and more with ease.
        </p>
      </div>
      ...
      <div className='flex items-center gap-4 mt-8 mx-auto text-gray-500'>
        <img src = {assets.user_group} alt="user group" className='h-8'/> Trusted by 10l+ people
      </div>
    </div>
  )
}
