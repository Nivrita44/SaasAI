...
const BlogTitles = () => {
   const blogCategories = [
     'General', 'Technology', 'Health', 'Lifestyle', 'Business', 'Education', 'Travel', 'Food', 'Entertainment', 'Sports'
    ]
    ...
    key={item}>{item}</span>))}
      ...
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 '>
            ...
            { !content ? (
              ...
              <div className='mt-3 max-h-[500px] overflow-y-auto w-full text-sm text-slate-700 leading-normal whitespace-pre-wrap'>
